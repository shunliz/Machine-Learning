...
 　　　　支持向量到超平面的距离为1/\|\|w\|\|21/\|\|w\|\|2,两个支持向量之间的距离为2/\|\|w\|\|22/\|\|w\|\|2。
...
　　　　对ψ\(α\)ψ\(α\)求极大化的数学表达式如下:maxα−12∑i=1m∑j=1mαiαjyiyj\(xi∙xj\)+∑i=1mαimax⏟α−12∑i=1m∑j=1mαiαjyiyj\(xi∙xj\)+∑i=1mαis.t.∑i=1mαiyi=0s.t.∑i=1mαiyi=0αi≥0i=1,2,...mαi≥0i=1,2,...m
